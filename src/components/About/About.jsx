      ...
      <div className="about-main">
        <div className="about-me">
          ...
          <div className="about-details">
            ...
            creating intuitive and visually captivating user experiences. My
            goal is to contribute to projects that not only showcase technical
            excellence but also prioritize user needs and satisfaction. As an
            enthusiastic learner, I actively seek opportunities to grow and
            refine my skills in web development while collaborating effectively
            within teams.
          </div>
          <div className="btn">
            <button>
              <a href={firdausnaseem} target="blank" download>
                {" "}
                Download Resume
              </a>
            </button>
